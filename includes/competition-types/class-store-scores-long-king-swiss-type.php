...
class Store_Scores_Long_King_Swiss_Type extends Store_Scores_Competition_Type {
    ...
    public function get_description() {
        ...
        $html .= '<p>You can play your preselected opponents in any order you wish. After you enter the score your latest opponent will disappear from your list of people to play.</p>';
        $html .= '</div>';
        return $html;
    }
