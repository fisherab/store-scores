 ...
 * @subpackage Store_Scores/includes
 */
...
class Store_Scores {
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Store_Scores_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - Store_Scores_Loader. Orchestrates the hooks of the plugin.
     * - Store_Scores_i18n. Defines internationalization functionality.
     * - Store_Scores_Admin. Defines all hooks for the admin area.
     * - Store_Scores_Public. Defines all hooks for the public side of the site.
     *
     ...
     *
     * Uses the Store_Scores_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
     ...
     *
     * @since     1.0.0
     * @return    Store_Scores_Loader    Orchestrates the hooks of the plugin.
     */
